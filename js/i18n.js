...
const i18n = {
    ko: {
        ...
        fullTypeComparison: '전체 타입 비교',
        fullTypeComparisonDesc: '문제가 있는 속성이 하이라이트되어 표시됩니다',
        errorLocations: '오류 위치',
    ...
    en: {
        ...
        feature1: '25+ error types supported',
        feature2: '4 languages supported',
        feature3: 'Instant analysis',
        feature4: 'Solution suggestions',
        navAnalyzer: 'Analyzer',
        guidesLink: 'Error Guides',
        aboutLink: 'About',
        ...
        fullTypeComparison: 'Full Type Comparison',
        fullTypeComparisonDesc: 'Properties with issues are highlighted',
    ...
    ja: {
        ...
        fullTypeComparison: '全体型の比較',
        fullTypeComparisonDesc: '問題のあるプロパティがハイライト表示されます',
        errorLocations: 'エラー位置',
    ...
    zh: {
        ...
        fullTypeComparison: '完整类型比较',
        fullTypeComparisonDesc: '有问题的属性已高亮显示',
        errorLocations: '错误位置',
        foundProblems: '发现的问题',
